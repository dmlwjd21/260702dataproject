import streamlit as pd  # 관례상 st로 임포트합니다.
...
MBTI_DATA = {
    ...
    "ENFJ": {"name": "토게키스 (Togekiss)", "id": 468, "emoji": "❤️", "jobs": ["인사단당자(HRD) 전문가", " NGO 활동가", "🗣️ 스피치 코치"]},
    "ENFP": {"name": "뮤 (Mew)", "id": 151, "emoji": "🌈", "jobs": ["🎉 이벤트 기획자", "마케터", "🎬 크리에이터"]},
